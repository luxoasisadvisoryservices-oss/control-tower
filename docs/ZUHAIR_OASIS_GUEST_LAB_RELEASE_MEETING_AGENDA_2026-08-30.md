# Zuhair / Oasis Guest Lab Release Meeting Agenda - 2026-08-30

## Source

Damiano sent Zuhair a release follow-up after this week's Oasis Guest Lab migration. The message says the migration went smoothly on Damiano's side and asks for a call this week to finalise remaining release items.

## Current State

- Migration: completed from Damiano's side.
- Product use: Damiano will start using the Maintenance page this week.
- Content/policy: consumables policy and neighbourhood info still need to be added.
- Meeting: needed this week with Zuhair to confirm release blockers, order, and timing.

## Questions Sent To Zuhair

1. How far are we from routing escalations to the right person, for example maintenance issues to maintenance and guest issues to Damiano?
2. Where does the translation layer sit on the roadmap?
3. Where are we with the Stripe connection to the dashboard?
...
1. Data integrity first: confirm Hostaway reservations, guest numbers, unit data, and post-migration sync health.
