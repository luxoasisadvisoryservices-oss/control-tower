# Lux Oasis Advisory Social Media Project - 2026-08-01

Purpose: start a proper social-media workstream for Lux Oasis Advisory & Services LLC around the short-term-rental ecosystem Damiano is building.

Slack channel: `#social-media-` / `C08BZGP36CV`.

Kickoff handoff to Lin: Slack message `1785572953.634289` on 2026-08-01.

Channel correction from Damiano: follow this project in the CEO/business or Lux Oasis Advisory board, not only the generic social-media channel and not as a Lux Oasis Holiday Homes-only lane. Current blocker: the bot is not a member of `#lux-oasis-advisory-and-services-` / `C0AQWTVJUK1`, and Slack rejected the join attempt with `missing_scope`.

CEO Strategy repost completed:

- Advisory-specific board: `#lux-aosis-advisory-and-serivces` / `C0B1XHNEHGE`, message `1785573493.942979`.
...
Lux Oasis Advisory & Services LLC is the umbrella company for the Lux Oasis short-term-rental ecosystem.
...
Lux Oasis Renovation / Interiors: STR-readiness, apartment refresh planning, setup, handover and quality control.
...
>
> We are starting with practical tools and services, then turning the strongest workflows into repeatable products.

## Content Rules

- Draft first, publish only after Damiano review.
- No guaranteed revenue, guaranteed occupancy or automatic-profit claims.
- No private guest, owner, operator or financial data.
- Do not claim product features are live unless verified.
- Use practical operator problems and real workflow lessons.
- Keep copy credible, founder-led and business-focused.

## Slack Access Notes

- `#social-media-` posting works.
- Slack topic and pin actions failed with `missing_scope`.
- The bot is not a member of `#lux-oasis-advisory-and-services-` / `C0AQWTVJUK1`; `conversations.join` failed with `missing_scope`.
